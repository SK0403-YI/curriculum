...
public class UndererSub {
	public String under_undererSub_public;
	protected String under_undererSub_protected;
	String under_undererSub_default;
	private String under_undererSub_private;
	...
	public void test(){
		...
		under_undererSub_public = "test";
		under_undererSub_protected = "test";
		under_undererSub_default = "test";
		under_undererSub_private = "test";
		
		//警告文回避用
		System.out.println(under_undererSub_private);
		
		/*
		 * ②同じパッケージ直下のUndererクラスの変数を使えるのか
		 */
